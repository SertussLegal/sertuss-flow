...
import { classifyApoderado, type ApoderadoPayload } from "../../shared/apoderadoClassifier.ts";
import { getProsaBanco, type ProsaContext, mergeOverride, type ProsaApoderadoOverride } from "../../shared/prosaBancos/index.ts";
