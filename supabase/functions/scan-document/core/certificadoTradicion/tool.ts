      ...
      properties: {
        ...
        inmueble: {
          ...
          properties: {
            ...
            codigo_orip: confField("Nombre completo de la Oficina de Registro de Instrumentos Públicos (ORIP). REGLA CRÍTICA: preservar la ZONA cuando aparezca en el encabezado del certificado. Bogotá tiene 7 zonas ORIP legalmente distintas (CENTRO, NORTE, SUR, OCCIDENTE, ZIPAQUIRÁ, FACATATIVÁ, FUSAGASUGÁ) y otras ciudades pueden tener zonificación similar. Si el encabezado dice 'REGISTRO DE INSTRUMENTOS PUBLICOS DE <CIUDAD> ZONA <ZONA>' → devolver '<CIUDAD> ZONA <ZONA>' (ej: 'BOGOTA ZONA CENTRO', 'BOGOTA ZONA NORTE', 'BOGOTA D.C. ZONA SUR'). Si no aparece 'ZONA' en el encabezado (ciudades con una sola oficina, ej: Medellín, Cali) → devolver solo la ciudad tal como aparece (ej: 'MEDELLIN', 'CALI'). Preservar mayúsculas y ortografía exactas del certificado. PROHIBIDO inventar zona si no está escrita literalmente; PROHIBIDO omitir la zona cuando sí aparece."),
