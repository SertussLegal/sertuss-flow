    ...
    <div className="space-y-6">
      ...
      {actos.es_hipoteca && (
        <div className="space-y-4 rounded-lg border p-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label>Valor de Crédito (COP) {ocr("valor_hipoteca")} {inlineDot("valor_hipoteca")}</Label>
            ...
            <div className="space-y-2">
              <Label>Entidad Bancaria {ocr("entidad_bancaria")} {inlineDot("entidad_bancaria")}</Label>
            ...
            <div className="space-y-2">
              <Label>NIT del Banco {inlineDot("entidad_nit")}</Label>
            ...
            <div className="space-y-2">
              <Label>Domicilio del Banco {inlineDot("entidad_domicilio")}</Label>
            ...
            <div className="space-y-2">
              <Label>Pago Inicial (COP) {inlineDot("pago_inicial")}</Label>
            ...
            <div className="space-y-2">
              <Label>Saldo Financiado (COP) {inlineDot("saldo_financiado")}</Label>
            ...
            <div className="space-y-2">
              <Label>Fecha del Crédito {inlineDot("fecha_credito")}</Label>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label>Nombre {ocr("apoderado_nombre")} {inlineDot("apoderado_nombre")}</Label>
            ...
            <div className="space-y-2">
              <Label>Cédula {ocr("apoderado_cedula")} {inlineDot("apoderado_cedula")}</Label>
            ...
            <div className="space-y-2">
              <Label>Expedida en {ocr("apoderado_expedida_en")} {inlineDot("apoderado_expedida_en")}</Label>
            ...
            <div className="space-y-2">
              <Label>Email {ocr("apoderado_email")} {inlineDot("apoderado_email")}</Label>
            ...
            <div className="space-y-2">
              <Label>Escritura del Poder No. {ocr("apoderado_escritura_poder")} {inlineDot("apoderado_escritura_poder")}</Label>
            ...
            <div className="space-y-2">
              <Label>Fecha del Poder {ocr("apoderado_fecha_poder")} {inlineDot("apoderado_fecha_poder")}</Label>
            ...
            <div className="space-y-2">
              <Label>Notaría del Poder {ocr("apoderado_notaria_poder")} {inlineDot("apoderado_notaria_poder")}</Label>
            ...
            <div className="space-y-2">
              <Label>Ciudad Notaría Poder {ocr("apoderado_notaria_ciudad")} {inlineDot("apoderado_notaria_ciudad")}</Label>
